/*
 * Programa de Simulación de Infección en una Población con Protección Homogénea
 *
 * Descripción:
 * Este programa realiza simulaciones de la dinámica de infección en una población de individuos,
 * considerando una cohorte de control y una cohorte vacunada leaky. Utiliza el algoritmo de Gillespie
 ...
 *
 * Archivos:
 * - individuos_leaky_N{N}_S{SIMUS}.txt: Archivo para guardar detalles de los individuos y su estado
